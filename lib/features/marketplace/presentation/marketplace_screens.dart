        ...
        actions: [
          ...
          IconButton(
            onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('تم تجهيز رابط المشاركة')),
            ),
      ...
      body: AppPage(
        child: Column(
          ...
          children: [
              ...
              children: [
                  ...
                  child: AppSurfaceCard(
                    child: Column(
                      children: [
                        ...
                        Text('جودة مضمونة', style: TextStyle(fontSize: 11)),
                      ],
                    ),
                  ),
                ),
                  ...
                  child: AppSurfaceCard(
                    child: Column(
                      children: [
                        ...
                        Text('توصيل سريع', style: TextStyle(fontSize: 11)),
                      ],
                    ),
                  ),
                ),
                ...
                Expanded(
                  child: AppSurfaceCard(
                    child: Column(
                      children: [
                        Icon(Icons.replay_rounded, color: AppColors.forest),
                        Text('إرجاع مرن', style: TextStyle(fontSize: 11)),
                      ],
                    ),
                  ),
                ),
            ...
            SegmentedButton<int>(
              segments: const [
                ButtonSegment(value: 0, label: Text('الوصف')),
                ButtonSegment(value: 1, label: Text('المواصفات')),
                ButtonSegment(value: 2, label: Text('التقييمات')),
                ButtonSegment(value: 3, label: Text('الأسئلة')),
              ],
              selected: {tab},
              showSelectedIcon: false,
              onSelectionChanged: (value) {
              ...
              const AppSurfaceCard(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Expanded(child: Text('يستخدم تحت إشراف الطبيب البيطري')),
                  ],
                ),
              ),
            ],
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) => SizedBox(
                  width: 145,
                  child: ProductCard(
                    product: app.products[(i + 1) % app.products.length],
                    onTap: () {},
                  ),
                ),
              ),
