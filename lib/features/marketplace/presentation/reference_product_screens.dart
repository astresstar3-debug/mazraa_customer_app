...
class ReferenceProductDetailsScreen extends StatefulWidget {
  ...
  @override
  State<ReferenceProductDetailsScreen> createState() =>
      _ReferenceProductDetailsScreenState();
}

class _ReferenceProductDetailsScreenState
    extends State<ReferenceProductDetailsScreen> {
  int quantity = 1;
  int selectedImage = 0;
  int tab = 0;
  ...
  Widget build(BuildContext context) {
    ...
    final images = product.images.isEmpty
        ? <String>[product.image, product.image, product.image]
        : product.images;
      ...
      body: AppPage(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 13),
            _StatusDataCard(product: product),
            const SizedBox(height: 11),
            _ProductMetaCard(product: product),
            ...
            _ProductTabBody(product: product, tab: tab),
            const SizedBox(height: 20),
            const Row(
              children: [
                Icon(Icons.auto_awesome_rounded, color: AppColors.forest),
                SizedBox(width: 6),
                Text(
                  'منتجات مشابهة',
                  style: TextStyle(
            ...
            _SimilarProducts(products: app.products),
          ],
        ),
      ),
    );
